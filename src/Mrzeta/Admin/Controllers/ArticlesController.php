...
use Mrzeta\Admin\Uploader\ImageUploader;
use Mrzeta\Admin\Validation\Article\Create;
use Mrzeta\Admin\Validation\Article\Update;
...
class ArticlesController extends BaseController
{
    ...
    {
        if (isOnPages()) {
            $repository = 'Mrzeta\Admin\Repositories\Pages\PageRepository';
        } else {
            $repository = 'Mrzeta\Admin\Repositories\Articles\ArticleRepository';
        }
