...
use Mrzeta\Admin\Entities\Option;
...
if (!function_exists('style')) {
    ...
    {
        return HTML::style('packages/mrzeta/admin/'.$url, $attributes, $secure);
    }
}
...
if (!function_exists('admin_asset')) {
    ...
    {
        return asset('packages/mrzeta/admin/'.$url, $secure);
    }
}
...
if (!function_exists('script')) {
    ...
    {
        return HTML::script('packages/mrzeta/admin/'.$url, $attributes, $secure);
    }
}
...
if (!function_exists('session_check')) {
    ...
    {
        if (!getenv('MRZETA_ADMIN_TESTING') && !app()->runningInConsole()) {
            session_start();
        }
    }
}
...
if (!function_exists('article')) {
    ...
    function article()
    {
        return new Mrzeta\Admin\Entities\Article();
    }
}
