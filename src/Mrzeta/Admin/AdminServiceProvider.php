...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected $providers = [
        ...
        'Mrzeta\Admin\Providers\ConsoleServiceProvider',
        'Mrzeta\Admin\Providers\RepositoriesServiceProvider',
    ];
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__.'/../../../public/' => public_path('packages/mrzeta/admin/'),
        ], 'assets');

        $viewPath = base_path('resources/views/vendor/mrzeta/admin/');
